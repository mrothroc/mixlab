...
func TestEmitPlainAttentionIR_KVSourceReusesCachedTensors(t *testing.T) {
	...
	wi, err := emitPlainAttentionIRWithKVOptions(p, "x", 0, 8, 4, 128, 64, 2, 0, DefaultFFNMultiplier, false, 0, false, 0, 0, false, false, 0, AttentionMaskCausal, 0, cache, 0)
	if err != nil {
	...
	wi, err = emitPlainAttentionIRWithKVOptions(p, "x", wi, 8, 4, 128, 64, 2, 1, DefaultFFNMultiplier, false, 0, false, 0, 0, false, false, 0, AttentionMaskCausal, 1, cache, 2)
	if err != nil {
