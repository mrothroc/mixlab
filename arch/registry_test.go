...
func TestRegistryBuiltinsRegistered(t *testing.T) {
	for _, name := range []string{"plain", "swiglu", "geglu", "mlp", "legacy_mamba", "gated_linear_ssm", "mamba3", "mamba3-canonical", "rwkv", "perceiver", "bottleneck", "retnet", "cross_attention", "token_blend", "custom"} {
