...
| `s4d` | Linear time-invariant diagonal SSM with an FFT-convolution training path. |
| `mamba3-canonical`, `gated_linear_ssm` | Selective/gated state-space token mixers. |
