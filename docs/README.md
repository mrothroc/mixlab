...
| Document | Purpose |
|----------|---------|
| [cli.md](cli.md) | CLI modes, flags, and evaluation export formats. |
...
| [config-reference.md](config-reference.md) | Exhaustive JSON configuration reference. |
...
then use [cli.md](cli.md), [data.md](data.md), and
[architecture.md](architecture.md) for day-to-day workflows.
